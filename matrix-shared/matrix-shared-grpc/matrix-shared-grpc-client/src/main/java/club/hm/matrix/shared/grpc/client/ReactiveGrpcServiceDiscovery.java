package club.hm.matrix.shared.grpc.client;
...
public class ReactiveGrpcServiceDiscovery {
    ...
    public Mono<ManagedChannel> getChannel(String serviceName) {
        ...
        // 异步创建新连接
        return createChannel(serviceName)
    ...
    private Mono<ManagedChannel> createChannel(String serviceName) {
    ...
    private int getGrpcPort(ServiceInstance instance) {
        // 从metadata获取gRPC端口
        var grpcPortMeta = instance.getMetadata().get("grpc.port");
