package osins.matrix.shared.snowflake.id.generator.config;

import osins.matrix.shared.snowflake.id.generator.BufferedIdService;
import osins.matrix.shared.snowflake.id.generator.IdService;
 ...
 */
@Configuration
@ComponentScan(basePackages = "osins.matrix.shared.snowflake.id.generator")
