...
public class UserAuthorityServerService extends UserAuthorityServiceGrpc.UserAuthorityServiceImplBase{

    private final club.hm.matrix.auth.data.service.UserAuthorityService userAuthorityService;
