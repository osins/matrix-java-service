package osins.matrix.auth.data.service;

import osins.matrix.shared.common.uitls.Longs;
import osins.matrix.auth.data.converter.PermissionConverter;
import osins.matrix.auth.data.converter.RoleConverter;
import osins.matrix.auth.data.converter.UserConverter;
import osins.matrix.auth.data.dto.UserDTO;
import osins.matrix.auth.data.dto.RoleDTO;
import osins.matrix.auth.data.dto.PermissionDTO;
...
import osins.matrix.auth.data.entity.SysUserRole;
import osins.matrix.shared.data.exception.DuplicateException;
import osins.matrix.shared.data.exception.NotFoundException;
import osins.matrix.auth.data.repos.*;
import osins.matrix.shared.snowflake.id.generator.BufferedIdService;
