package osins.matrix.client.server.api.controller;

import osins.matrix.shared.common.uitls.JSON;
import osins.matrix.client.server.api.MessageApplication;
import osins.matrix.client.server.common.domain.MatrixMessageEvent;
import osins.matrix.client.server.common.domain.RoomMessageContent;
