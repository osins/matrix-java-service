package osins.matrix.client.server.api.handler;

import osins.matrix.shared.common.uitls.JSON;
import osins.matrix.shared.common.uitls.Strings;
import osins.matrix.client.server.api.annotation.MessageMapping;
import osins.matrix.client.server.api.annotation.WsHandler;
import osins.matrix.client.server.common.domain.MatrixMessageEvent;
